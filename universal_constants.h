...
//
//#define CRITICAL_DENSITY 1.24951e11 // 3H^2/8piG in (Msun) / (Mpc)^3
//#define VMAX_CONST 6.55833746e-5 //sqrt(G*(Msun)/(Mpc)) in km/s
//#define RMAX_TO_RS 2.1626        /* Rvmax / Rs */
//#define RS_CONSTANT 0.216216595 /* ln(1+2.1626)/2.1626 - 1/(1+2.1626) */
//
// #define CRITICAL_DENSITY 2.0379e11 // z=0.5 

#define CRITICAL_DENSITY 1.25134e11 // 3H^2/8piG in (Msun) / (Mpc)^3
#define VMAX_CONST 6.55833746e-5 //sqrt(G*(Msun)/(Mpc)) in km/s
#define RMAX_TO_RS 2.1626        /* Rvmax / Rs */
#define RS_CONSTANT 0.216216595 /* ln(1+2.1626)/2.1626 - 1/(1+2.1626) */
