...
string(MASS_DEFINITION, "200c");
string(MASS_DEFINITION2, "200c");
string(MASS_DEFINITION3, "200c");
string(MASS_DEFINITION4, "200c");
string(MASS_DEFINITION5, "200c");
integer(STRICT_SO_MASSES, 0);
integer(MIN_HALO_OUTPUT_SIZE, 20);
real(FORCE_RES, 0.00017); //In Mpc/h
...
real(GADGET_LENGTH_CONVERSION, 0.001);
// 2023.05.11 ZXY: initially 0.001*0.7, but now canceled 0.7 ......
